---
name: coach.step
description: Run one full coaching step — start session, choose approach (PCO or IntelligentDesign), improve, save session. This is the skill that /loop calls every 30 minutes. Use when asked to "run a coaching step" or "coach step".
---
...
2. `/coach.improve` — choose approach, make improvement, test, submit
